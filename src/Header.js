  ...
  return (
    <header className='container'>
      ...
      <nav>
        <div
          className={`${
            scrollPosition > 400 ? 'return-btn' : 'return-btn hidden'
          }`}
        >
          <a href='#'>
            <button
        ...
        >
          ...
          <div className='hamburger-nav'>
            <div
              className={
                !hamburgerMenu
                  ? 'hamburger-nav-items hamburger-nav-home'
                  : 'hamburger-nav-items hamburger-nav-home hamburger-nav-opened'
              }
            >
              Home
            </div>
            <a
              ...
              className={
                !hamburgerMenu
                  ? 'hamburger-nav-items hamburger-nav-home'
                  : 'hamburger-nav-items hamburger-nav-portfolio hamburger-nav-opened'
              }
            >
              <div>Portfolio</div>
            </a>
            <a
              ...
              className={
                !hamburgerMenu
                  ? 'hamburger-nav-items hamburger-nav-home'
                  : 'hamburger-nav-items hamburger-nav-contact hamburger-nav-opened'
              }
            >
              <div>Contact</div>
            </a>
